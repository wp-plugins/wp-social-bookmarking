 ...
 $img_var =  get_option('wp_social_ico');   //"30px";
	...
	if ( is_single ) {  
		...
		$content .= '<div class="WP-Social-Bookmarking"> ' . "\n"  
	 		. '<a href="http://www.onlinerel.com/sfeed/?f=' . $post_l . '" target="_blank" title="Onlinerel"><img src="' . $images . 'onlinerel.png" style="width:' . $img_var . ';height:' . $img_var . ';border:0px;" alt="Onlinerel" title="Onlinerel" /></a>' . "\n"
